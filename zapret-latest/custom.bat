...
set LIST_PATH="$(dirname "$0")/lists/list-ultimate.txt"
set GMODE_FLAG_FILE="${BIN}gmode.flag"
set DISCORD_IPSET_PATH="$(dirname "$0")/lists/ipset-discord.txt"
set CLOUDFLARE_IPSET_PATH="$(dirname "$0")/lists/ipset-cloudflare.txt"
