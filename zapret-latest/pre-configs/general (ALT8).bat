...
start "%LIST_TITLE%" /min "%BIN%winws.exe" --wf-tcp=80,4433,%GModeRange% --wf-udp=443,1400,596-599,50000-50100,%GModeRange% ^
...
--filter-udp=1400,596-599,50000-50100 --ipset="%DISCORD_IPSET_PATH%" --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --new ^
